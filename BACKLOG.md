...
| Improvement 22: default-edge priorities | Current validators exclude default edges from priority collisions; overlaps the historical bug 24 / PR #31 entry. |
